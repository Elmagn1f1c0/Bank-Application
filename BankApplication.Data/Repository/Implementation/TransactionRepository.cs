...
namespace BankApplication.Data.Repository.Implementation
{
    public class TransactionRepository : ITransactionRepository
    {
        ...
        //        // Now let me update their account balances
        //        if (decimal.TryParse(sourceAccount.CurrentAccountBalance, out decimal sourceBalance) &&
        //            decimal.TryParse(destinationAccount.CurrentAccountBalance, out decimal destinationBalance))
        //        {
